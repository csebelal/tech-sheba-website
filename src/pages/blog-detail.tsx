...
const blogDataMap: Record<string, BlogData> = {
  'office-network-guide': {
    ...
    content: (
      <>
        <p className="text-[#475569] dark:text-[#94a3b8] leading-relaxed mb-6 text-lg">
        ...
        <h2 className="text-2xl font-bold text-[#1e293b] dark:text-[#e2e8f0] mb-4 mt-10">
          Why Your Network Setup Matters
        </h2>
        <p className="text-[#475569] dark:text-[#94a3b8] leading-relaxed mb-4">
        ...
        <blockquote className="border-l-4 border-[#001F60] dark:border-[#93c5fd] bg-[#eff6ff] dark:bg-[#1e293b] rounded-r-xl p-6 my-8">
          <p className="text-[#001440] dark:text-[#93c5fd] font-medium italic leading-relaxed">
          ...
          <p className="text-[#001F60] dark:text-[#93c5fd] text-sm mt-2 font-semibold">â€” Imran Hossain, Lead Network Engineer at Tech Sheba</p>
        </blockquote>
        ...
        <h3 className="text-xl font-bold text-[#1e293b] dark:text-[#e2e8f0] mb-3 mt-8">
          MikroTik Routers
        </h3>
        <p className="text-[#475569] dark:text-[#94a3b8] leading-relaxed mb-4">
        ...
        <ul className="space-y-3 mb-6">
          {[
            ...
            <li key={idx} className="flex items-start gap-3">
              <div className="w-6 h-6 rounded-full bg-[#001F60]/10 dark:bg-[#93c5fd]/10 flex items-center justify-center shrink-0 mt-0.5">
                <span className="text-[#001F60] dark:text-[#93c5fd] text-xs font-bold">{idx + 1}</span>
              </div>
              <span className="text-[#475569] dark:text-[#94a3b8] leading-relaxed">{item}</span>
            </li>
          ))}
        </ul>
        ...
        <ul className="space-y-3 mb-6">
          {[
            ...
            <li key={idx} className="flex items-start gap-3">
              <div className="w-2 h-2 rounded-full bg-[#001F60] dark:bg-[#93c5fd] shrink-0 mt-2" />
              <span className="text-[#475569] dark:text-[#94a3b8] leading-relaxed">{item}</span>
            </li>
          ))}
        </ul>
    ...
    content: (
      <>
        ...
        <blockquote className="border-l-4 border-[#001F60] dark:border-[#93c5fd] bg-[#eff6ff] dark:bg-[#1e293b] rounded-r-xl p-6 my-8">
          ...
          <p className="text-[#001F60] dark:text-[#93c5fd] text-sm mt-2 font-semibold">â€” Sabrina Islam, Security Solutions Lead at Tech Sheba</p>
        </blockquote>
    ...
    content: (
      <>
        ...
        <blockquote className="border-l-4 border-[#001F60] dark:border-[#93c5fd] bg-[#eff6ff] dark:bg-[#1e293b] rounded-r-xl p-6 my-8">
          ...
          <p className="text-[#001F60] dark:text-[#93c5fd] text-sm mt-2 font-semibold">â€” Faruq Rahman, Founder & CEO at Tech Sheba</p>
        </blockquote>
...
export default function BlogDetailPage() {
  ...
  return (
    <div className="overflow-hidden">
      ...
      <section className="relative pt-32 pb-12 bg-gradient-to-br from-[#eff6ff] via-white to-[#f0f4ff] dark:from-[#0f172a] dark:via-[#0f172a] dark:to-[#1e293b] overflow-hidden">
        <div
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <FadeIn>
            <nav className="flex items-center gap-2 text-sm text-[#64748b] dark:text-[#94a3b8] mb-6 flex-wrap">
              <button
              ...
              <ChevronRight className="w-4 h-4" />
              <span className="text-[#001F60] dark:text-[#93c5fd] font-medium truncate max-w-[200px] sm:max-w-none">
          ...
          <FadeIn delay={0.15}>
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-[#1e293b] dark:text-[#e2e8f0] mb-6 tracking-tight leading-tight max-w-4xl">
              {post.title}
            </h1>
          </FadeIn>

          <FadeIn delay={0.2}>
            <div className="flex flex-wrap items-center gap-4 md:gap-6 text-sm text-[#64748b] dark:text-[#94a3b8]">
              <span className="flex items-center gap-2">
                <div className="w-8 h-8 rounded-full bg-[#001F60]/10 dark:bg-[#93c5fd]/10 flex items-center justify-center">
                  <User className="w-4 h-4 text-[#001F60] dark:text-[#93c5fd]" />
                </div>
                <span className="font-medium text-[#1e293b] dark:text-[#e2e8f0]">
                  {post.author}
                </span>
              </span>
      ...
      <section className="bg-white dark:bg-[#0f172a]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mb-16 relative z-10">
          <FadeIn delay={0.1}>
            <div className="relative w-full h-56 sm:h-72 md:h-80 rounded-2xl overflow-hidden shadow-xl bg-[#f1f5f9] dark:bg-[#334155]">
              <Image
                src={post.imageSrc}
                alt={post.title}
                fill
      ...
      <section className="py-24 lg:py-28 bg-white dark:bg-[#0f172a]">
            ...
            <div className="lg:col-span-2">
              ...
              <FadeIn delay={0.2}>
                <div className="mt-12 pt-8 border-t border-[#e2e8f0] dark:border-[#334155]">
                  <Button
                    variant="outline"
                    className="border-[#001F60]/20 text-[#001F60] hover:bg-[#eff6ff] hover:text-[#001F60] dark:hover:bg-[#1e3a5f] dark:hover:text-[#93c5fd] transition-all duration-300"
                    onClick={() => navigate('blog')}
                  >
            ...
            <div className="lg:col-span-1">
              <div className="sticky top-28 space-y-8">
                  ...
                  <Card className="border-[#e2e8f0] dark:border-[#334155] bg-white dark:bg-[#1e293b]">
                    <CardContent className="p-6">
                      ...
                      <div className="flex items-center gap-4 mb-4">
                        ...
                        <div>
                          <h4 className="font-bold text-[#1e293b] dark:text-[#e2e8f0]">
                            {post.author}
                          </h4>
                          <p className="text-sm text-[#001F60] dark:text-[#93c5fd] font-medium">
                            {post.authorTitle}
                          </p>
                        </div>
                      </div>
                ...
                <FadeIn delay={0.3} direction="left">
                  <Card className="border-[#dbeafe] dark:border-[#1e3a5f] bg-gradient-to-br from-[#eff6ff] to-[#f0f4ff] dark:from-[#1e293b] dark:to-[#1e293b]">
                    <CardContent className="p-6">
                      <h4 className="font-bold text-[#1e293b] dark:text-[#e2e8f0] text-lg mb-2">
              ...
              <StaggerItem key={rPost.slug}>
                ...
                >
                  <CardContent className="p-0">
                    <div className="relative h-40 overflow-hidden bg-[#f8fafc] dark:bg-[#334155]">
                      <Image
                        src={rPost.imageSrc}
                        alt={rPost.title}
                        fill
                    ...
                    <div className="p-6">
                      ...
                      <h3 className="text-lg font-bold text-[#1e293b] dark:text-[#e2e8f0] mb-2 group-hover:text-[#001F60] dark:group-hover:text-[#93c5fd] transition-colors duration-300 leading-snug line-clamp-2">
                        {rPost.title}
                      </h3>
                      <div className="flex items-center gap-3 text-xs text-[#64748b] dark:text-[#94a3b8] mt-4 pt-4 border-t border-[#f1f5f9] dark:border-[#334155]">
